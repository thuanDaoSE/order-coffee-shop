...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse createOrder(CreateOrderRequest request, String userEmail) {
        ...
        if ("delivery".equalsIgnoreCase(request.getDeliveryMethod())) {
            ...
            com.coffeeshop.backend.dto.ShippingInfoDTO shippingInfo = shippingService.calculateShippingFeeForStore(store.getId(), address.getLatitude(), address.getLongitude());

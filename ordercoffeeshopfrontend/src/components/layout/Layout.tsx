...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen w-full bg-amber-50 flex flex-col">
      ...
      <footer className="bg-amber-900 text-white pt-12 pb-6 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-amber-100">
                We are passionate about serving the finest coffee in town, made from carefully selected beans and brewed to perfection.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <span>123 Coffee Street, District 1, HCMC</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 mr-2 text-amber-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#menu-preview" className="text-amber-100 hover:text-white transition-colors">Menu</a></li>
                ...
                <li><a href="#" className="text-amber-100 hover:text-white transition-colors">Blog</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-amber-100">
                <li className="flex justify-between"><span>Monday - Friday:</span> <span>7:00 AM - 10:00 PM</span></li>
              ...
              <div className="mt-4">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="text-amber-100 hover:text-white transition-colors">
                    ...
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.06 1.2.48 2.43 1.67 2.73 1.2.29 2.5-.37 2.88-1.49.19-.59.35-1.23.36-1.9v-.02h3.87v14.56c0 4.83-3.3 9.3-9.14 9.3-5.83 0-9.18-4.46-9.18-9.3 0-5.15 3.92-9.2 9.14-9.2.2 0 .4.01.6.02v3.2c-1.82-.06-3.5.61-4.8 1.86-1.3 1.25-2.01 3.01-2.01 4.82 0 3.25 2.4 5.94 5.7 6.4.5.1 1 .15 1.5.15 2.7 0 4.9-1.9 5.5-4.6.1-.5.2-1.1.2-1.6V6.4c-.6.3-1.3.5-2 .6.8-.9 1.3-2.1 1.4-3.4-.9.5-1.9.9-3 1z" />
                    </svg>
                  </a>
                </div>
              </div>
          ...
          {/* Copyright */}
          <div className="border-t border-amber-800 pt-6 mt-8 text-center text-amber-100">
